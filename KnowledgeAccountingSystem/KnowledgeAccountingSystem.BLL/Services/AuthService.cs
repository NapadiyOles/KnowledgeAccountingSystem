...
namespace KnowledgeAccountingSystem.BLL.Services
{
    ...
    public class CopyOfAuthService : IAuthService
    {
        private readonly IUnitOfWork context;
        private readonly IMapper mapper;
        private readonly IConfiguration configuration;
        private readonly IOptions<AuthOptions> authOptions;
        public CopyOfAuthService(IUnitOfWork context, IMapper mapper, IConfiguration configuration, IOptions<AuthOptions> authOptions)
        {
            this.configuration = configuration;
            this.context = context;
            this.mapper = mapper;
